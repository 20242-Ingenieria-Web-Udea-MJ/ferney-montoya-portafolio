...
const SocialMediaList = () => {
  return (
    <div className="w-full md:top-0 pl-4 py-2 bg-white flex items-center md:flex-col md:pl-0 md:p-0 md:pt-7 md:w-36 md:h-full">
      <TitleBasic>Links</TitleBasic>
      <ul className="flex ml-4 md:flex-col md:justify-center md:items-center md:ml-0 md:mt-4 md:w-20">
        <li className="ml-2 md:mb-4 md:ml-0">
